...
/**
 * Renders an individual user story, as a card, on a planning board or similar.
 */
  ...
  render() {
    ...
    return (
        <div className={classes.UserStory}>
          ...
          <div className={classes['UserStory__Body']}>
            <h1 className={classes.UserStory__Body__Title}>{this.props.story.title}</h1>
          </div>
